      ...
      <div className="col-lg-10 col-md-8 col-12 mx-auto">
        <nav className="nav nav-pills nav-fill mb-4">
          ...
          <button
            ...
            type="button"
            className={`nav-link ${active === 'Refund Policy' ? 'active' : ''}`}
          >
            Refund Policy
          </button>
        </nav>
        ...
        {active === 'Privacy Policy' && (
          <div>
            ...
            <ul>
              ...
              <li>
                <strong>Communication Information: </strong> Any correspondence
                we have with you, including emails and chat logs.
              </li>
              <li>
                <strong> Device Information: </strong> Information about the
                device you use to access our services, such as IP address,
            ...
            <ul>
              ...
              <li>
                <strong>Personalization: </strong> To tailor our services to
                meet your preferences and improve your experience.
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                third-party service providers to perform various functions on
                our behalf, such as payment processing and customer support.
                These providers have limited access to personal information
                necessary to perform their tasks.{' '}
              </li>
              <li>
                <strong>Business Partners: </strong> We may share your
                information with our business partners to offer you relevant
              ...
              <li>
                <strong>Safety and Security: </strong> We may share information
                to protect our rights, property, and safety, as well as the
            ...
            <ul>
              <li>
                ...
                encryption protocols, such as Secure Socket Layer (SSL) or
                Transport Layer Security (TLS), to establish a secure connection
                between your device and our servers. This encryption helps
                protect your payment details during transmission, making it
                difficult for unauthorized parties to intercept or access the
                information.{' '}
              </li>
              ...
              <li>
                ...
                payments. These payment processors are compliant with Payment
                Card Industry Data Security Standard (PCI DSS) requirements,
                which are designed to protect the security of cardholder data.
              </li>

              <li>
                <strong>Limited Data Storage: </strong> We minimize the storage
                of sensitive payment details. Once your payment is processed, we
                securely store only the necessary information required for
                record-keeping, compliance, and customer support purposes. We
                adhere to data retention practices to ensure that payment
                details are not stored longer than necessary.
              </li>

              <li>
                <strong>Internal Access Controls: </strong> We have strict
                access controls in place to limit access to payment details
                within our organization. Only authorized personnel with a
                legitimate need to access this information, such as for customer
                support or billing purposes, are granted access. We regularly
                review and audit our internal access controls to ensure
                compliance and minimize the risk of unauthorized access.
              </li>
              ...
              <li>
                ...
                However, we continuously review and update our security
                practices to mitigate risks and maintain the highest possible
            ...
            <p>
              ...
              completely impenetrable, and we cannot guarantee absolute
              security.
            </p>
            ...
            <p>
              ...
              our website or through other appropriate channels.
            </p>
        ...
        {active === 'Refund Policy' && (
          <div>
            ...
            <p>
              ...
              medical certificates, or any other relevant documents, depending
              on the circumstances surrounding the refund request.
              <br />
              3.3. Refund Evaluation: Each refund request will be evaluated
              based on the specific circumstances and the applicable terms and
            ...
            <p>
              ...
              administration charges may apply. These fees, if applicable, will
              be clearly communicated to the customer before the refund is
              processed.
            </p>
            ...
            <p>
              ...
              conditions and cancellation policies provided by the airline
            ...
            <p>
              ...
              upon posting on our website or mobile application. Customers are
              encouraged to review the refund policy periodically to stay
