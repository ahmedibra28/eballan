    ...
    <div className="row">
      <div className="col-lg-10 col-md-8 col-12 mx-auto">
        ...
        <p>
          ...
          using our website, mobile application, or any other platform provided
          by us (collectively referred to as the &quot;Service&quot;), you agree
        ...
        <p>
          ...
          details, manage reservations, and access related travel information.
          The availability of flights and other travel services is subject to
          change and may be provided by third-party airlines or travel
          providers. We strive to provide accurate and up-to-date information,
          but we do not guarantee the availability, accuracy, or completeness of
        ...
        <ul>
          <li style={{ listStyle: 'none' }}>
            <strong>2.1 Eligibility:</strong> By using the Service, you
            represent and warrant that you are at least 18 years old or have the
            ...
            you represent and warrant that you have the authority to bind such
          ...
          <li style={{ listStyle: 'none' }}>
            ...
            You shall not use the Service for any unlawful, fraudulent, or
        ...
        <ul>
          <li style={{ listStyle: 'none' }}>
            <strong>3.1 Ownership:</strong> The Service and its content,
            including but not limited to text, graphics, images, logos,
            trademarks, and software, are owned by us or our licensors and are
            protected by intellectual property laws.
          </li>
          <li style={{ listStyle: 'none' }}>
            <strong>3.2 Restrictions:</strong> You may use the Service solely
            for personal, non-commercial purposes in accordance with these
            Terms. You shall not modify, copy, distribute, transmit, display,
            ...
            obtained from the Service without our prior written consent.
          </li>
        </ul>
        ...
        <p>
          ...
          to our collection, use, and disclosure of your personal information as
        ...
        <p>
          ...
          in whole or in part, at any time and without prior notice. We shall
          not be liable to you or any third party for any such modifications,
        ...
        <p>
          ...
          laws of Somali Federal Republic. Any disputes arising out of or
          relating to these Terms or the Service shall be resolved exclusively
          through binding arbitration in accordance with the rules of the Osman
          Public Notary. The arbitration shall take place in Somalia and shall
        ...
        <p>
          ...
          or understandings. Our failure to enforce any right or provision of
