...
export const eReservation = ({
  ...
  <html lang="en">
    ...
    >
      ...
      >
        <img
          src="https://sahalbook.sgp1.cdn.digitaloceanspaces.com/sahalbook/eballan/eballan-bg-blue.png"
          alt=""
          class="img-fluid"
        ...
        >
          <img
            src="https://sahalbook.sgp1.cdn.digitaloceanspaces.com/sahalbook/eballan/eballan-qrcode.png"
            alt="qrcode"
            class="img-fluid"
            style="width: 80px"
          />
        ...
        <div class="box" style="width: 100%; height: auto; padding: 10px">
          ...
          ><label>WhatsApp: <strong>+252 61 598 011</strong><br /> </label
          ><label
